...
second_fyq_month_one <- pmin(as.Date("01-Jul-13", format="%d-%b-%y"))
second_fyq_month_two <- pmin(as.Date("01-Aug-13", format="%d-%b-%y"))
second_fyq_month_three <- pmin(as.Date("01-Sep-13", format="%d-%b-%y"))
